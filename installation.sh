...
#===============================================================================
# creating enviornment and installing bedtools for annotation
#===============================================================================

echo "---------------------------------------------------------"
echo "creating enviornment and installing bedtools for annotation"
echo "---------------------------------------------------------"

conda create -n 06_bedtools -y
conda activate 06_bedtools
...
echo "---------------------------------------------------------"
echo "successfully install bedtools"
echo "---------------------------------------------------------"

#===============================================================================
# creating enviornment and installing featurecounts for count matrix
#===============================================================================

echo "---------------------------------------------------------"
echo "creating enviornment and installing featurecounts for count matrix"
echo "---------------------------------------------------------"

conda create -n 07_subread -y
...
echo "---------------------------------------------------------"
echo "successfully install subread"
echo "---------------------------------------------------------"
